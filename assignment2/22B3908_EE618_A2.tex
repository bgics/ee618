...
\begin{titlepage}
	...
	\begin{tabular}{rl}
		...
		\textbf{Submission Date:} & 10 Sep 2025
	\end{tabular}
...
\[
	I_{SD} = \frac{0.9}{4.5~\text{k}\Omega} \approx \SI{200}{\micro\ampere}.
\]
...
\]
Using the requirement $g_{mp} \geq \SI{2}{\milli\siemens}$ and the calculated drain current $I_{SD} = \SI{200}{\micro\ampere}$, we obtain
\[
